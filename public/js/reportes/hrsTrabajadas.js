    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.length>0){
                ...
                $('#Greporte').show()
                let canvas= $('<canvas id="horasTrabajadas" width="00px" height="300px">')
                ...
                grafico(posiciones,hrs,color,borde);
                $('#Greporte').hide()
...
function grafico(nombres,datos,color,borde){
    ...
    var myChart = new Chart(document.getElementById('horasTrabajadas'),config)
...
function generarTabla(inicio,fin){
    ...
    $.ajax({
        url: "/horasTrabajadas/reporte/desde="+inicio+'/hasta='+fin,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        cache: false,
        contentType: false,
        ...
        success: function(data){
            ...
            if(data.length>0){
                ...
                cabecera.append('<th scope="col">Hrs</th>')
...
function pdfTabla(){
    let inicio= $('input#iniB').val()
    let fin=$('input#finB').val()
    window.open("http://127.0.0.1:8000/descargar/horasTrabajadas/"+inicio+"/"+fin)
}
function verGrafico(){
...
function pdfGrafico(){
    ...
    window.open("http://127.0.0.1:8000/descargar/horasTrabajadas/grafico/"+inicio+"/"+fin)
}